    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "external_link",
                    django_extensions.db.fields.json.JSONField(default=list),
                ),
                (
                    "min_players",
                    models.PositiveSmallIntegerField(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, through="games.Collection", to="games.Game"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="artist_of", to="games.Person"
            ),
        ),
        migrations.AddField(
            model_name="game",
            name="category",
            field=models.ManyToManyField(
                blank=True, related_name="games", to="games.Category"
            ),
        ),
        migrations.AddField(
            model_name="game",
            name="compilation_of",
            field=models.ManyToManyField(
                blank=True, related_name="contained_in", to="games.Game"
            ),
        ),
        migrations.AddField(
            model_name="game",
            name="designer",
            field=models.ManyToManyField(
                blank=True, related_name="designer_of", to="games.Person"
            ),
        ),
        migrations.AddField(
            model_name="game",
            name="game_type",
            field=models.ManyToManyField(
                blank=True, related_name="games", to="games.GameType"
            ),
        ),
        migrations.AddField(
            model_name="game",
            name="implements",
            field=models.ManyToManyField(
                blank=True, related_name="implemented_by", to="games.Game"
            ),
        ),
        migrations.AddField(
            model_name="game",
            ...
            field=models.ManyToManyField(
                blank=True, related_name="_game_integrates_with_+", to="games.Game"
            ),
        ),
        migrations.AddField(
            model_name="game",
            name="mechanic",
            field=models.ManyToManyField(
                blank=True, related_name="games", to="games.Mechanic"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name="game",
            index=models.Index(
                fields=["-rec_rating", "-bayes_rating", "-avg_rating"],
                name="games_game_rec_rat_3cf101_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="collection",
            index=models.Index(
                fields=["user", "owned"], name="games_colle_user_id_b77c0a_idx"
            ),
        ),
    ]
