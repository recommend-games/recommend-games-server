# Generated by Django 2.2.4 on 2019-08-31 05:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ranking_type', models.CharField(choices=[('bgg', 'BoardGameGeek'), ('fac', 'Factor'), ('sim', 'Similarity')], db_index=True, default='bgg', max_length=3)),
