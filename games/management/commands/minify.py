...
def _walk_files(path, exclude_files=None):
    ...
    filter_file = (
        partial(_filter_file, exclude_files=exclude_files) if exclude_files else None
    )
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            "-d",
            action="store_true",
            help="delete destination before copying",
        )
        parser.add_argument(
            "--exclude", "-e", nargs="+", help="exclude these file names"
        )
        parser.add_argument(
            "--exclude-dot",
            "-E",
