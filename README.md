...
read the [contribution guidelines](CONTRIBUTING.md). For how a release reaches
production, read the [deployment guidelines](DEPLOY.md).
...
a PyTorch matrix factorisation model. Scraped data files are merged with
[board-game-merger](https://gitlab.com/recommend.games/board-game-merger).
